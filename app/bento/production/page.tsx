              ...
              <div style={{ padding: '12px 11px' }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => toggleProductionCard(card)}
                    ...
                    style={{ background: done ? '#16a34a' : '#431407', border: `1px solid ${done ? '#15803d' : '#9a3412'}`, padding: '8px 10px', minWidth: 58 }}>
                    <span style={{ color: done ? '#fff' : '#fb923c' }}>{done ? CheckIcon(18) : CircleIcon(18)}</span>
                    <span className="text-[11px]" style={{ color: done ? '#fff' : '#fb923c' }}>{done ? 'Done' : 'Pending'}</span>
                  </button>
                </div>
              </div>
            </div>
