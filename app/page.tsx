    ...
    <main data-page-capture className="min-h-screen bg-gray-50 w-full mx-auto relative">
      ...
      <div className="px-4 pt-4 pb-28 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          {canAccessPath(staff.role, '/reservations') && <Link href="/reservations" className="bg-blue-50 rounded-xl p-2.5 text-center block overflow-hidden">
          ...
          {canAccessPath(staff.role, '/complaints') && <Link href="/complaints" className="bg-red-50 rounded-xl p-2.5 text-center block overflow-hidden">
          ...
          {canAccessPath(staff.role, '/incidents') && <Link href="/incidents" className="bg-orange-50 rounded-xl p-2.5 text-center block overflow-hidden">
        ...
        {canAccessPath(staff.role, '/staff') && <Link href="/staff" className="bg-white rounded-2xl p-4 shadow-sm block">
