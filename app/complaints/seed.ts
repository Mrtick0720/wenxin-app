...
export const seedComplaints: Complaint[] = [
  {
    ...
    complaintMethod: 'On-site Complaint', responsiblePerson: 'Kitchen Staff',
  ...
  },
  {
    ...
    complaintMethod: 'On-site Complaint', responsiblePerson: 'Service Staff',
...
export function emptyComplaint(nextId: number): Complaint {
  ...
  return {
    ...
    date: daysAgo(0),
    complaintMethod: 'On-site Complaint',
